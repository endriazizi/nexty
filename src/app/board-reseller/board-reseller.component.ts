...
@Component({
  selector: 'app-board-reseller',
  templateUrl: './board-reseller.component.html',
  styleUrls: ['./board-reseller.component.css']
})
export class BoardResellerComponent implements OnInit {
